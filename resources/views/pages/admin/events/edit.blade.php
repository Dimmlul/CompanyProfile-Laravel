    ...
    <div>
        ...
        <textarea name="description" rows="3"
                  class="shadow-theme-xs w-full rounded-lg
                         border border-gray-300 bg-transparent
                         px-4 py-3 text-sm
                         dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">{{ old('description', $event->description) }}</textarea>
    </div>
    ...
    <div>
        ...
        <textarea name="content" rows="6" required
                  class="shadow-theme-xs w-full rounded-lg
                         border border-gray-300 bg-transparent
                         px-4 py-3 text-sm
                         dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">{{ old('content', $event->content) }}</textarea>
    </div>
