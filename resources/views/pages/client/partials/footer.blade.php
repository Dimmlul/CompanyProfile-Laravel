    ...
    >
        ...
        >
            ...
            <div class="md:justify-self-end">
                ...
                <ul class="mt-5 space-y-4 text-sm text-app-muted">
                    ...
                    @if (filled($companyProfile->phone))
                        <li class="flex items-center gap-3">
                            <svg class="h-4 w-4 text-indigo-400"
                                 ...
                                 viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      d="M2 3.5A1.5 1.5 0 013.5 2h2A1.5 1.5 0 017 3.5v2A1.5 1.5 0 015.5 7H4.121a14.978 14.978 0 006.757 6.757V12.5A1.5 1.5 0 0112.5 11h2a1.5 1.5 0 011.5 1.5v2A1.5 1.5 0 0114.5 16h-.5C7.373 16 2 10.627 2 4v-.5z"/>
                            </svg>
