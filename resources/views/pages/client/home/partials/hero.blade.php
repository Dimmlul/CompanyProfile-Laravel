<section class="relative overflow-hidden bg-app-bg">
    ...
    <div class="absolute inset-0">
        ...
        <div class="absolute inset-0 bg-gradient-to-b
                    from-app-bg/90 via-app-bg/70 to-app-bg"></div>
    </div>
